...
;;u¿ytych do wy¶wietlania danych na LCD
;;wy¶wietlanie 8 bitowe

;def lcd
;ca³y port RB0-RB7 u¿yty jako dane do LCD
;	rb0	db0
;       rb1	db1
;       rb2	db2
;       rb3	db3
...
;	ra4
;init
;to idzie na port zwi±zany z danymi
;czyli RB
set_4bit	equ	b'00000010' ;- ustawia 4 bit
...
dd_addres_set	equ	b'10000000' ;od rb6 do rb0 wstawiæ adres

display_clear	equ	b'00000001'
display_on	equ	b'00001111'
display_2	equ	b'00001111'
write_4bit	equ	b'00010000' ;pisz na ekranie
write		equ	b'01000000' ;za³±cz rd6 - rs
...
;to zale¿y od sterownika ja mam SSCB2
;LCD_cmd_SET_DDRAM	equ	80h
;linia_górna	equ	0x80
;linia_dolna	equ	0x40

linia_gorna	equ	080h
linia_dolna	equ	0C0h
linia_trzecia	equ	090h
linia_czwarta	equ	0d0h
;
;sposób wysy³ania 4bitów
